...
// the below code was moved to the knexfile.js file as the DEVELOPMENT object
// const knexConfig = {
//   client: 'sqlite3',
//   connection: {
...
// };
// const db = knex(knexConfig);  since the knexConfig was relocated we write this code as below
const db = knex(knexConfig.development); // this brings in the development Object from the knexfile.js file
